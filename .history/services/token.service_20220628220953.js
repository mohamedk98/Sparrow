...
const removeToken = async(refreshTokenId)=>{
  const userDataRepository = redisClient.fetchRepository(redisUserSchema);
  const redisUser = userDataRepository.remove(refreshTokenId)
}

module.exports = { createRefreshToken, createToken, createRedisRefreshToken,removeToken };
