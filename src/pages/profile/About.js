            ...
            <div className="lg:w-5/6 w-full mt-3 xl:ml-20 lg:ml-14">
              <div className="bg-white my-3 p-4 rounded-xl dark:bg-zinc-800 dark:text-slate-100 transition duration-700">
                ...
                {otherUserState.currentLoginAccount && (
                  <div
                    className="flex gap-2.5 items-center w-3/4 mx-auto mt-4 text-xl text-indigo-500 cursor-pointer"
                ...
                <div className="w-3/4 m-auto p-3 text-gray-600 dark:text-slate-100">
                  <div className="flex justify-between items-center my-3 p-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg mx-2">
                        {t("Works at")}{" "}
                        <span className="underline">{otherUserState.work}</span>
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center my-3 p-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg mx-2">
                        ...
                        <span className="underline">
                          {otherUserState.major}
                        </span>{" "}
                        at{" "}
                        <span className="underline">
                          {otherUserState.university}
                        </span>
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center my-3 p-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg mx-2">
                        {t("Lives in")}{" "}
                        <span className="underline">{otherUserState.town}</span>
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center my-3 p-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg mx-2 underline">
                        {otherUserState.relationship}
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center my-3 p-2">
                ...
                <div className="flex flex-wrap gap-2.5 border my-3 rounded-lg p-3">
                  {otherUserState?.hobbies?.map((hobby, index) => {
                    return (
                      <div
                        key={index}
                        className="flex h-fit items-center text-base py-2 px-3 rounded-3xl w-fit border bg-indigo-500 dark:bg-zinc-500 text-white"
                      >
                        <span>{hobby}</span>
                      </div>
                    );
