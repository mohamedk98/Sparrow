          ...
          <div className=" fixed top-0 left-0 z-50 w-full h-full mt-8 outline-none overflow-x-hidden overflow-y-auto">
            <div className="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
              ...
              {loading ? (
                ...
                <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current z-50">
                  {/*header*/}
                  ...
                  <div className="modal-body container space-x-2 p-4">
                    ...
                    <div className="relative left-12">
                      <select
                        ...
                        className="px-2 py-1 bg-facebook-grey text-black font-medium text-xs leading-tight rounded hover:bg-facebook-grey hover:shadow-lg focus:bg-facebook-grey focus:shadow-lg focus:outline-none focus:ring-0 active:bg-facebook-grey active:shadow-lg active:text-black flex items-center whitespace-nowrap"
                        type="button"
                      >
                        <option
                          value="Public"
