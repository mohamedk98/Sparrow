...
function PostView() {
    return (
        <div className="bg-white dark:bg-darkBgSideBar dark:text-white my-3 p-4 rounded-xl w-full shadow-md">
            <div className="grid grid-cols-2 gap-2.5 items-center">
                <div className="text-xl font-bold">
                    Posts
                </div>
                <div className="flex gap-2.5 lg:ml-8">
                    <div className="bg-slate-200 dark:bg-darkBgColor rounded-lg p-3 cursor-pointer hover:brightness-95">
            ...
            <div className="flex justify-around my-0.5">
                <div className="text-gray-600 dark:text-white font-semibold rounded-lg py-1 px-4 cursor-pointer hover:bg-slate-100">
