...
function Intro() {
    ...
    return (
        <div className="bg-white my-3 p-4 rounded-xl shadow-md">
            ...
            <div>
                {showBioButton&&<div className="bg-slate-200 rounded-lg p-2 text-center my-5 cursor-pointer hover:brightness-95" onClick={()=>{setBio(true);setShowBioButton(false)}}>
