    ...
    return (
        <div className="bg-white my-3 p-4 rounded-xl w-full">
            <div className="flex gap-2.5">
                <img src={defaultPic} alt="ptofilePic" className="rounded-full w-12 h-12 cursor-pointer hover:brightness-95"></img>
                <input placeholder="What's on your mind?" className="bg-slate-200 rounded-3xl w-11/12 p-3 cursor-pointer hover:brightness-95"></input>
            </div>
