    ...
    <div className="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
      <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
        <div className="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">  
          <h5 className="text-xl font-bold leading-normal text-black" id="exampleModalScrollableLabel">
           Create post
          </h5>
        ...
        <div
          ...
          <div className='flex '>
            <div className='justify-end my-2 text-2xl text-gray-500 '>
             {/* emoji picker */}
             <button onClick={()=>setShowPicker(!showPicker)}> <VscSmiley/> </button>
             {
                showPicker?(
                    <EmojiPicker chosenEmoji={chosenEmoji} onEmojiClick={onEmojiClick}/>
                ):null
             }
            </div>
          </div>
